...
export default function LowPolyMan() {
  const group = useRef();
  const { nodes, materials, animations } = useGLTF("/models/low-poly-man/low-poly-man.gltf");

  /**
   * TEXTURE
   */
  const bakedLowPolyManTexture = useTexture(
    "./textures/low-poly-man/baked-low-poly-man.jpg"
  );
  bakedLowPolyManTexture.flipY = false;
    ...
    <group ref={group} dispose={null}>
      <group name="Scene">
        ...
        >
          ...
          >
            <meshBasicMaterial map={bakedLowPolyManTexture} />
          </skinnedMesh>
        </group>
      </group>
    </group>
...
useGLTF.preload("/models/low-poly-man/low-poly-man.gltf");
