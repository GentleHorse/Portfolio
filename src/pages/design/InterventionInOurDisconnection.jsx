        ...
        <div id="page">
          ...
          >
            ...
            <div className="flex flex-col xl:flex-row">
              ...
              <p className="mb-[36px] xl:mb-[72px] xl:grow text-[18px] xl:text-[28px] text-[#C1C1C1]">
                “Intervention in our Disconnection” is a unique book holder that
                celebrates the beauty of discarded industrial materials.
          ...
          >
            ...
            <p className="hidden-element mb-[18px] xl:mb-[125px] text-[16px] xl:text-[22px] text-[#C1C1C1]">
              ...
              made production processes increasingly complex, distancing us from
              direct interaction with raw materials. This disconnect not only
              reduces opportunities to engage with these materials but also
              limits our ability to appreciate their inherent qualities.
              Industrial waste is a byproduct of this system. However, these
              discarded materials, with their unintended and unique shapes,
              possess untapped potential. Their irregular forms reveal a
              richness and beauty that can inspire creativity, offering a chance
              to reimagine waste as a valuable resource rather than something to
              be discarded.
            </p>
          </section>
          ...
          >
            ...
            <p className="hidden-element mb-[18px] xl:mb-[125px] text-[16px] xl:text-[22px] text-[#C1C1C1]">
              Each piece of marble stone waste has a distinct shape, with its
              most unique feature often found at the edges. To highlight this
              aspect, the designer made these edges the focal point of the
              product's connection, drawing inspiration from the traditional
              Japanese technique "<i>Hikaritsuke (光付け)</i> ." This method
              involves seamlessly joining two materials without gaps, preventing
              light from passing through. Historically, Hikaritsuke was used in
              temple and shrine foundations, where stone supported entire wooden
              structures. Craftsmen would precisely carve the edges of wooden
              beams to fit the stone's irregular surface, ensuring a perfect,
              gapless connection that emphasised strength and craftsmanship.
            </p>
          </section>
          ...
          <section className="pt-[124px] mx-[10vw] xl:mx-[240px]">
            ...
            <p className="hidden-element mb-[18px] xl:mb-[125px] text-[16px] xl:text-[22px] text-[#C1C1C1]">
              ...
              appearance. As a result, the product design is intentionally
              simple, using only two materials: marble and wood. The wood
              surfaces are carefully scraped to emphasise their natural grain,
              complementing the marble's unique qualities. This minimalistic
              approach ensures that the rich textures of both materials shine
          ...
          >
            ...
            <p className="hidden-element mb-[18px] xl:mb-[125px] text-[16px] xl:text-[22px] text-[#C1C1C1]">
              To maintain harmony in the product's design, the designer created
              a series of book holders with minimal material alteration. Each
              ...
              beauty of the wood and stone. By encouraging interaction, the
              design fosters a deeper appreciation for the materials' unique
              qualities while providing practical functionality in a simple,
              elegant form.
            </p>
          </section>
