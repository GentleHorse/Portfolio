        ...
        <div id="page">
          ...
          <section className="my-[124px] mx-[10vw] xl:mx-[240px]">
            ...
            <p className="hidden-element mb-[18px] xl:mb-[125px] text-[16px] xl:text-[22px] text-[#C1C1C1]">
              ...
              spaces. In his 1933 essay "In Praise of Shadows," Junichiro
              Tanizaki observed that individuals of that era embraced this warm
              darkness, using it to discover their own aesthetics by dissolving
              the boundaries between objects and the surrounding shadows. This
              blending of light and dark created an intimate atmosphere.
              Inspired by this idea, the product features dimmable lighting and
              carefully selected wood colors, allowing users to actively
              manipulate the interplay of light and darkness, enhancing the
              ambiance of their spaces.
            </p>
          </section>
          ...
          >
            ...
            <p className="hidden-element mb-[18px] xl:mb-[125px] text-[16px] xl:text-[22px] text-[#C1C1C1]">
              ...
              range of light reflections, resulting in distinct ambiances within
              a space. To replicate this beautiful effect in the absence of
              natural light, the "Ambience of Light" product is designed with
              modular components. This modularity enables users to create
              various compositions, allowing them to manipulate light
              reflections and craft different atmospheres. As a result,
