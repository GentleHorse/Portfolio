...
const IMAGE_LOADED_CHECK_ARRAY = [
...
export default function AmbienceOfLightPage() {
  ...
  useState(() => {
    setLoadedImages([...IMAGE_LOADED_CHECK_ARRAY]);
  }, [IMAGE_LOADED_CHECK_ARRAY.length]);
  ...
  return (
    <>
      {loadedImages.length !== 10 && (
        <h1 className="text-5xl text-stone-50">LOADING ....</h1>
      )}
          ...
          <div id="page">
            ...
            >
              ...
              <div className="flex flex-col xl:flex-row">
                ...
                <p className="mb-[36px] xl:mb-[72px] xl:grow text-[18px] xl:text-[28px] text-[#C1C1C1]">
                  ...
                  industrial glass blocks, originally designed to capture
                  daylight, to create a distinctive and atmospheric lighting
                  experience in any space.
                </p>
              </div>
            ...
            >
              ...
              <p className="hidden-element mb-[18px] xl:mb-[125px] text-[16px] xl:text-[22px] text-[#C1C1C1]">
                Industrial glass blocks were originally invented to bring
                daylight into domestic and commercial spaces comfortably. Their
            ...
            >
              ...
              <p className="hidden-element mb-[18px] xl:mb-[125px] text-[16px] xl:text-[22px] text-[#C1C1C1]">
                Before electric lighting, people in Japan used "Andon" lamps,
                made from paper stretched over bamboo, wood, or metal frames, to
                illuminate spaces. The paper gently diffused light from a single
                source, creating a soft, warm glow that fostered a calm and
                inviting atmosphere. Inspired by this traditional design,
                "Ambience of Light" follows the same principle to recreate a
                similar warmth. By using a single light source, it captures the
                subtle and soothing illumination of Andon lamps, blending
                tradition with modernity to create a cosy, ambient glow in
                contemporary spaces.
              </p>
            </section>
            ...
            <section className="my-[124px] mx-[10vw] xl:mx-[240px]">
              ...
              <p className="hidden-element mb-[18px] xl:mb-[125px] text-[16px] xl:text-[22px] text-[#C1C1C1]">
                ...
                light sources for Andon lamps, resulting in typically dark
                living spaces. In his 1933 essay "In Praise of Shadows,"
                Junichiro Tanizaki observed that individuals of that era
                embraced this warm darkness, using it to discover their own
                aesthetics by dissolving the boundaries between objects and the
                surrounding shadows. This blending of light and dark created an
                intimate atmosphere. Inspired by this idea, the product features
                dimmable lighting and carefully selected wood colors, allowing
                users to actively manipulate the interplay of light and
            ...
            >
              ...
              <p className="hidden-element mb-[18px] xl:mb-[125px] text-[16px] xl:text-[22px] text-[#C1C1C1]">
                ...
                range of light reflections, resulting in distinct ambiances
                within a space. To replicate this beautiful effect in the
                absence of natural light, the "Ambience of Light" product is
                designed with modular components. This modularity enables users
                to create various compositions, allowing them to manipulate
                light reflections and craft different atmospheres. As a result,
                individuals can enjoy a dynamic, ever-changing ambiance that
                mirrors the natural variations of daylight, enriching their
                indoor environments.
              </p>
            </section>
