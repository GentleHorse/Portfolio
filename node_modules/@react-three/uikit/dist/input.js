...
export const Input = forwardRef((properties, ref) => {
    ...
    useComponentInternals(ref, parent.root.pixelSize, propertySignals.style, internals, internals.interactionPanel, useMemo(() => ({ focus: internals.focus, current: internals.valueSignal }), [internals.focus, internals.valueSignal]));
    return (_jsx(AddHandlers, { allowSkippingChildren: true, userHandlers: properties, handlers: internals.handlers, ref: outerRef, children: _jsx("primitive", { object: internals.interactionPanel }) }));
});
