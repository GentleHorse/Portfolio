...
export declare function computedScrollHandlers(scrollPosition: Signal<Vector2Tuple | undefined>, anyAncestorScrollable: Signal<readonly [boolean, boolean]> | undefined, { scrollable, maxScrollPosition }: FlexNodeState, object: Object3DRef, interactionPanel: Mesh, listeners: Signal<ScrollListeners | undefined>, root: Pick<RootContext, 'onFrameSet' | 'requestRender' | 'pixelSize' | 'requestFrame'>, initializers: Initializers): ReadonlySignal<ScrollEventHandlers | undefined>;
/**
 * true = positivie
 * false = negative
 */
