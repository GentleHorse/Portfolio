...
import {
  ...
  quat,
  useRapier
} from "./chunk-ULKICMK7.js";
import "./chunk-A3HJAQVY.js";
import {
  useControls
} from "./chunk-MOD4ZR6W.js";
import "./chunk-ZMEGERF3.js";
import {
  useAnimations,
  useGLTF,
  useKeyboardControls
} from "./chunk-EULYHKY5.js";
import {
  create
} from "./chunk-NLIX3WXL.js";
import "./chunk-7RJPRD27.js";
import "./chunk-TFO3NKRS.js";
import "./chunk-QBJ2PHO4.js";
import "./chunk-5O7Z7GXJ.js";
import "./chunk-TADRPE3Q.js";
...
function EcctrlAnimation(props) {
  ...
  return import_react15.default.createElement(import_react15.Suspense, { fallback: null }, import_react15.default.createElement("group", { ref: group, dispose: null, userData: { camExcludeCollision: true } }, props.children));
}
var JoystickComponents = (props) => {
  ...
  return import_react15.default.createElement(import_react15.Suspense, { fallback: "null" }, import_react15.default.createElement(animated.group, { "position-x": springs.basePositionX, "position-y": springs.basePositionY }, import_react15.default.createElement("mesh", { geometry: joystickBaseGeo, material: joystickBaseMaterial, rotation: [-Math.PI / 2, 0, 0], ...props.joystickBaseProps })), import_react15.default.createElement(animated.group, { "rotation-x": springs.topRotationX, "rotation-y": springs.topRotationY }, import_react15.default.createElement("mesh", { geometry: joystickStickGeo, material: joystickStickMaterial, rotation: [-Math.PI / 2, 0, 0], position: [0, 0, 1.5], ...props.joystickStickProps }), import_react15.default.createElement("mesh", { geometry: joystickHandleGeo, material: joystickHandleMaterial, position: [0, 0, 4], ...props.joystickHandleProps })));
};
var ButtonComponents = ({ buttonNumber = 1, ...props }) => {
  ...
  return import_react15.default.createElement(import_react15.Suspense, { fallback: "null" }, buttonNumber > 0 && import_react15.default.createElement(
    animated.group,
    {
    ...
    import_react15.default.createElement("mesh", { geometry: buttonLargeBaseGeo, material: buttonBaseMaterial, ...props.buttonLargeBaseProps, onPointerDown: () => onPointerDown(1) }),
    import_react15.default.createElement("mesh", { geometry: buttonTop1Geo, material: buttonTop1Material, position: [0, -0.3, 0], ...props.buttonTop1Props })
  ), buttonNumber > 1 && import_react15.default.createElement(
    animated.group,
    {
    ...
    import_react15.default.createElement("mesh", { geometry: buttonLargeBaseGeo, material: buttonBaseMaterial, ...props.buttonLargeBaseProps, onPointerDown: () => onPointerDown(2) }),
    import_react15.default.createElement("mesh", { geometry: buttonTop2Geo, material: buttonTop2Material, position: [0, -0.3, 0], ...props.buttonTop2Props })
  ), buttonNumber > 2 && import_react15.default.createElement(
    animated.group,
    {
    ...
    import_react15.default.createElement("mesh", { geometry: buttonSmallBaseGeo, material: buttonBaseMaterial, ...props.buttonSmallBaseProps, onPointerDown: () => onPointerDown(3) }),
    import_react15.default.createElement("mesh", { geometry: buttonTop3Geo, material: buttonTop3Material, position: [0, -0.3, 0], ...props.buttonTop3Props })
  ), buttonNumber > 3 && import_react15.default.createElement(
    animated.group,
    {
    ...
    import_react15.default.createElement("mesh", { geometry: buttonSmallBaseGeo, material: buttonBaseMaterial, ...props.buttonSmallBaseProps, onPointerDown: () => onPointerDown(4) }),
    import_react15.default.createElement("mesh", { geometry: buttonTop4Geo, material: buttonTop4Material, position: [0, -0.3, 0], ...props.buttonTop4Props })
  ), buttonNumber > 4 && import_react15.default.createElement(
    animated.group,
    {
    ...
    import_react15.default.createElement("mesh", { geometry: buttonSmallBaseGeo, material: buttonBaseMaterial, ...props.buttonSmallBaseProps, onPointerDown: () => onPointerDown(5) }),
    import_react15.default.createElement("mesh", { geometry: buttonTop5Geo, material: buttonTop5Material, position: [0, -0.3, 0], ...props.buttonTop5Props })
  ));
};
var EcctrlJoystick = (0, import_react15.forwardRef)((props, ref) => {
  ...
  return import_react15.default.createElement("div", { ref }, import_react15.default.createElement("div", { id: "ecctrl-joystick", style: joystickWrapperStyle, onContextMenu: (e) => e.preventDefault() }, import_react15.default.createElement(
    Canvas,
    {
      shadows: true,
      orthographic: true,
    ...
    import_react15.default.createElement(JoystickComponents, { ...props }),
    props.children
  )), props.buttonNumber !== 0 && import_react15.default.createElement("div", { id: "ecctrl-button", style: buttonWrapperStyle, onContextMenu: (e) => e.preventDefault() }, import_react15.default.createElement(
    Canvas,
    {
      shadows: true,
      orthographic: true,
    ...
    import_react15.default.createElement(ButtonComponents, { ...props }),
    props.children
  )));
});
...
var Ecctrl = ({
  ...
  const crossVecOnX = (0, import_react15.useMemo)(() => new Vector3(), []);
  const crossVecOnY = (0, import_react15.useMemo)(() => new Vector3(), []);
  const crossVecOnZ = (0, import_react15.useMemo)(() => new Vector3(), []);
  const bodyContactForce = (0, import_react15.useMemo)(() => new Vector3(), []);
  const slopeRayOriginUpdatePosition = (0, import_react15.useMemo)(() => new Vector3(), []);
  const camBasedMoveCrossVecOnY = (0, import_react15.useMemo)(() => new Vector3(), []);
  ...
  const cameraSetups = {
    ...
    camZoomSpeed: isModeFixedCamera ? 0 : camMoveSpeed,
  ...
  return import_react15.default.createElement(
    ...
    isModePointToMove && import_react15.default.createElement(
      CylinderCollider,
      {
        ref: bodySensorRef,
        sensor: true,
    ...
    import_react15.default.createElement("group", { ref: characterModelRef, userData: { camExcludeCollision: true } }, import_react15.default.createElement(
      "mesh",
      {
        position: [
          rayOriginOffest.x,
      ...
      import_react15.default.createElement("boxGeometry", { args: [0.15, 0.15, 0.15] })
    ), children)
  );
};
var Ecctrl$1 = (0, import_react15.forwardRef)(Ecctrl);
export {
  EcctrlAnimation,
  EcctrlJoystick,
  Ecctrl$1 as default,
