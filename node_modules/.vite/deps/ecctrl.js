import {
  ...
  quat,
  useRapier
} from "./chunk-AGITZLSI.js";
import "./chunk-GZS6NCTV.js";
import {
  useControls
} from "./chunk-H2Y5I54U.js";
...
// node_modules/ecctrl/node_modules/zustand/esm/vanilla.mjs
...
// node_modules/ecctrl/node_modules/zustand/esm/index.mjs
...
// node_modules/ecctrl/node_modules/zustand/esm/middleware.mjs
...
var useFollowCam = function(props) {
  ...
  const pivot = (0, import_react16.useMemo)(() => new Object3D(), []);
  const followCam = (0, import_react16.useMemo)(() => {
  ...
  const cameraRayDir = (0, import_react16.useMemo)(() => new Vector3(), []);
  const cameraRayOrigin = (0, import_react16.useMemo)(() => new Vector3(), []);
  const cameraPosition = (0, import_react16.useMemo)(() => new Vector3(), []);
  const camLerpingPoint = (0, import_react16.useMemo)(() => new Vector3(), []);
...
function EcctrlAnimation(props) {
  const group = (0, import_react16.useRef)();
  ...
  return (0, import_jsx_runtime.jsx)(import_react16.Suspense, { fallback: null, children: (0, import_jsx_runtime.jsx)("group", { ref: group, dispose: null, userData: { camExcludeCollision: true }, children: props.children }) });
}
var JoystickComponents = (props) => {
  ...
  let joystickDis = 0;
  let joystickAng = 0;
  const touch1MovementVec2 = (0, import_react16.useMemo)(() => new Vector2(), []);
  const joystickMovementVec2 = (0, import_react16.useMemo)(() => new Vector2(), []);
  const [windowSize, setWindowSize] = (0, import_react16.useState)({ innerHeight, innerWidth });
  ...
  const joystickBaseGeo = (0, import_react16.useMemo)(() => new CylinderGeometry(2.3, 2.1, 0.3, 16), []);
  const joystickStickGeo = (0, import_react16.useMemo)(() => new CylinderGeometry(0.3, 0.3, 3, 6), []);
  const joystickHandleGeo = (0, import_react16.useMemo)(() => new SphereGeometry(1.4, 8, 8), []);
  const joystickBaseMaterial = (0, import_react16.useMemo)(() => new MeshNormalMaterial({ transparent: true, opacity: 0.3 }), []);
  const joystickStickMaterial = (0, import_react16.useMemo)(() => new MeshNormalMaterial({ transparent: true, opacity: 0.3 }), []);
  const joystickHandleMaterial = (0, import_react16.useMemo)(() => new MeshNormalMaterial({ transparent: true, opacity: 0.7 }), []);
  const setJoystick = useJoystickControls((state) => state.setJoystick);
  const resetJoystick = useJoystickControls((state) => state.resetJoystick);
  const onTouchMove = (0, import_react16.useCallback)((e) => {
    e.preventDefault();
    e.stopImmediatePropagation();
    const touch1 = e.targetTouches[0];
  ...
  return (0, import_jsx_runtime.jsxs)(import_react16.Suspense, { fallback: "null", children: [
...
var ButtonComponents = ({ buttonNumber = 1, ...props }) => {
  const buttonLargeBaseGeo = (0, import_react16.useMemo)(() => new CylinderGeometry(1.1, 1, 0.3, 16), []);
  const buttonSmallBaseGeo = (0, import_react16.useMemo)(() => new CylinderGeometry(0.9, 0.8, 0.3, 16), []);
  const buttonTop1Geo = (0, import_react16.useMemo)(() => new CylinderGeometry(0.9, 0.9, 0.5, 16), []);
  const buttonTop2Geo = (0, import_react16.useMemo)(() => new CylinderGeometry(0.9, 0.9, 0.5, 16), []);
  const buttonTop3Geo = (0, import_react16.useMemo)(() => new CylinderGeometry(0.7, 0.7, 0.5, 16), []);
  const buttonTop4Geo = (0, import_react16.useMemo)(() => new CylinderGeometry(0.7, 0.7, 0.5, 16), []);
  const buttonTop5Geo = (0, import_react16.useMemo)(() => new CylinderGeometry(0.7, 0.7, 0.5, 16), []);
  const buttonBaseMaterial = (0, import_react16.useMemo)(() => new MeshNormalMaterial({ transparent: true, opacity: 0.3 }), []);
  const buttonTop1Material = (0, import_react16.useMemo)(() => new MeshNormalMaterial({ transparent: true, opacity: 0.5 }), []);
  const buttonTop2Material = (0, import_react16.useMemo)(() => new MeshNormalMaterial({ transparent: true, opacity: 0.5 }), []);
  const buttonTop3Material = (0, import_react16.useMemo)(() => new MeshNormalMaterial({ transparent: true, opacity: 0.5 }), []);
  const buttonTop4Material = (0, import_react16.useMemo)(() => new MeshNormalMaterial({ transparent: true, opacity: 0.5 }), []);
  const buttonTop5Material = (0, import_react16.useMemo)(() => new MeshNormalMaterial({ transparent: true, opacity: 0.5 }), []);
...
var EcctrlJoystick = (0, import_react16.forwardRef)((props, ref) => {
...
var Ecctrl = (0, import_react16.forwardRef)(({
  children,
  debug = false,
  ...
  const characterRef = ref || (0, import_react16.useRef)();
  const characterModelRef = (0, import_react16.useRef)();
  const characterModelIndicator = (0, import_react16.useMemo)(() => new Object3D(), []);
  ...
  const modelFacingVec = (0, import_react16.useMemo)(() => new Vector3(), []);
  const bodyFacingVec = (0, import_react16.useMemo)(() => new Vector3(), []);
  const bodyBalanceVec = (0, import_react16.useMemo)(() => new Vector3(), []);
  const bodyBalanceVecOnX = (0, import_react16.useMemo)(() => new Vector3(), []);
  const bodyFacingVecOnY = (0, import_react16.useMemo)(() => new Vector3(), []);
  const bodyBalanceVecOnZ = (0, import_react16.useMemo)(() => new Vector3(), []);
  const vectorY = (0, import_react16.useMemo)(() => new Vector3(0, 1, 0), []);
  const vectorZ = (0, import_react16.useMemo)(() => new Vector3(0, 0, 1), []);
  const bodyContactForce = (0, import_react16.useMemo)(() => new Vector3(), []);
  ...
  const gamepadJoystickVec2 = (0, import_react16.useMemo)(() => new Vector2(), []);
  ...
  const mergedKeys = (0, import_react16.useMemo)(() => Object.assign({}, defaultControllerKeys, controllerKeys), [controllerKeys]);
  ...
  let canJump = false;
  let isFalling = false;
  const initialGravityScale = (0, import_react16.useMemo)(() => props.gravityScale || 1, []);
  let massRatio = 1;
  let isOnMovingObject = false;
  const standingForcePoint = (0, import_react16.useMemo)(() => new Vector3(), []);
  const movingObjectDragForce = (0, import_react16.useMemo)(() => new Vector3(), []);
  const movingObjectVelocity = (0, import_react16.useMemo)(() => new Vector3(), []);
  const movingObjectVelocityInCharacterDir = (0, import_react16.useMemo)(() => new Vector3(), []);
  const distanceFromCharacterToObject = (0, import_react16.useMemo)(() => new Vector3(), []);
  const objectAngvelToLinvel = (0, import_react16.useMemo)(() => new Vector3(), []);
  const velocityDiff = (0, import_react16.useMemo)(() => new Vector3(), []);
  let dirLight = null;
  const cameraSetups = {
    disableFollowCam,
    disableFollowCamPos,
  ...
  const pivotPosition = (0, import_react16.useMemo)(() => new Vector3(), []);
  const modelEuler = (0, import_react16.useMemo)(() => new Euler(), []);
  const modelQuat = (0, import_react16.useMemo)(() => new Quaternion(), []);
  const moveImpulse = (0, import_react16.useMemo)(() => new Vector3(), []);
  const movingDirection = (0, import_react16.useMemo)(() => new Vector3(), []);
  const moveAccNeeded = (0, import_react16.useMemo)(() => new Vector3(), []);
  const jumpVelocityVec = (0, import_react16.useMemo)(() => new Vector3(), []);
  const jumpDirection = (0, import_react16.useMemo)(() => new Vector3(), []);
  const currentVel = (0, import_react16.useMemo)(() => new Vector3(), []);
  const currentPos = (0, import_react16.useMemo)(() => new Vector3(), []);
  const dragForce = (0, import_react16.useMemo)(() => new Vector3(), []);
  const dragAngForce = (0, import_react16.useMemo)(() => new Vector3(), []);
  const wantToMoveVel = (0, import_react16.useMemo)(() => new Vector3(), []);
  const rejectVel = (0, import_react16.useMemo)(() => new Vector3(), []);
  let floatingForce = null;
  const springDirVec = (0, import_react16.useMemo)(() => new Vector3(), []);
  const characterMassForce = (0, import_react16.useMemo)(() => new Vector3(), []);
  const rayOrigin = (0, import_react16.useMemo)(() => new Vector3(), []);
  const rayCast = new rapier.Ray(rayOrigin, rayDir);
  let rayHit = null;
  let slopeAngle = null;
  let actualSlopeNormal = null;
  let actualSlopeAngle = null;
  const actualSlopeNormalVec = (0, import_react16.useMemo)(() => new Vector3(), []);
  const floorNormal = (0, import_react16.useMemo)(() => new Vector3(0, 1, 0), []);
  const slopeRayOriginRef = (0, import_react16.useRef)();
  const slopeRayorigin = (0, import_react16.useMemo)(() => new Vector3(), []);
  ...
  const crossVector = (0, import_react16.useMemo)(() => new Vector3(), []);
  const pointToPoint = (0, import_react16.useMemo)(() => new Vector3(), []);
  const getMoveToPoint = useGame((state) => state.getMoveToPoint);
  const bodySensorRef = (0, import_react16.useRef)();
