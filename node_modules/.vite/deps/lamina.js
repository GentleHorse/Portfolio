...
import "./chunk-VEU2MNKE.js";
import "./chunk-GSFJWQ2T.js";
import {
  require_client
} from "./chunk-K755R7SD.js";
import "./chunk-4KORULZU.js";
import "./chunk-MDVFIVSO.js";
import {
  extend
} from "./chunk-6R3D2TEM.js";
import {
  _extends
...
// node_modules/lamina/node_modules/three-custom-shader-material/vanilla.js
...
var Depth$1 = class _Depth$1 extends Abstract {
  constructor(props) {
    super(_Depth$1, {
      ...
      const mapping = _Depth$1.getMapping(self.uuid, self.mapping);
...
var Noise$1 = class _Noise$1 extends Abstract {
  constructor(props) {
    super(_Noise$1, {
      ...
      const noiseFunc = _Noise$1.getNoiseFunction(self.type);
      const mapping = _Noise$1.getMapping(self.mapping);
...
var Gradient$1 = class _Gradient$1 extends Abstract {
  constructor(props) {
    super(_Gradient$1, {
      ...
      const mapping = _Gradient$1.getMapping(self.mapping);
...
var Displace$1 = class _Displace$1 extends Abstract {
  constructor(props) {
    super(_Displace$1, {
      ...
      const noiseFunc = _Displace$1.getNoiseFunction(self.type);
      const mapping = _Displace$1.getMapping(self.mapping);
